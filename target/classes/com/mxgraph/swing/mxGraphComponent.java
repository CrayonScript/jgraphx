...
public class mxGraphComponent extends JScrollPane implements Printable {
    ...
    public void addTemplateCell() {
        ...
        templateCell.setCellType(CellTypeEnum.TEMPLATE);
    ...
    public mxCell createAssignmentShape(String name, String initialText)
    {
        String style = name;
        String value = "";
        int width = 420;
    ...
    public mxCell createFunctionExpressionShape(String name, String initialText)
    {
        String style = name;
        String value = "";
        int width = 420;
